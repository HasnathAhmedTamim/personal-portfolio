      ...
      <div className="flex flex-col items-center justify-center py-10">
        <div className="w-full max-w-5xl">
          ...
          <p className="mt-8 md:p-2 p-6  text-justify leading-relaxed text-sm">
            ...
            solutions. I&apos;m also actively involved in research, having
            published a paper on &quot;Effective Fault Prediction Techniques for
            Green Cloud Computing Environments using Machine Learning&quot; at
            ICO2023.
          </p>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3 p-4 bg-bg-tertiary rounded-lg shadow-sm border border-gray-700">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-text-secondary">
                    Software development lifecycle & programming tasks
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-bg-tertiary rounded-lg shadow-sm border border-gray-700">
