      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold text-primary mb-4">Hasnath Ahmed Tamim</h3>
            <p className="text-text-secondary mb-6 leading-relaxed">
              Full Stack Developer passionate about creating innovative web solutions. 
              Experienced in React.js, Node.js, and modern web technologies. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-2 text-sm text-text-secondary">
                <p><span className="font-medium">BSc in Computer Science & Engineering</span> - East West University (CGPA: 3.23/4.00)</p>
                <p><span className="font-medium">Professional Masters in IT</span> - Jahangirnagar University (Ongoing)</p>
              </div>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-3 text-primary">Research</h4>
              <div className="text-sm text-text-secondary">
                <p className="font-medium mb-1">ICO2023 Published Research:</p>
                <p>&quot;Effective Fault Prediction Techniques for Green Cloud Computing Environments Using Machine Learning&quot;</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-tertiary text-sm">
            © {new Date().getFullYear()} Hasnath Ahmed Tamim. All rights reserved.
          </p>
